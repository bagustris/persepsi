...
contoh suara laki-laki dapat mengganggu (menutupi) suara perempuan.

Emisi Otoakustik
Gampangnya, suara mengeluarkan telinga. 
Suara mengeluarkan telinga? 

Jika sistem pendengaran berfungsi dengan baik, maka karena ketidaklinearan akan 
...
Report:
Investigasi tentang ketidaklinearan sistem pendengaran.
Survey, summarize about nonlinearities of auditory system.

Some non-linearities on the human auditory system and its model

A. Non-linearities in the cochlea:
1. If you double the input to the basilar membrane, the output less than doubles (saturating non-linearity). 

2. If you add a second tone at a different frequency, the response to the first tone decreases (Two-tone suppression)
